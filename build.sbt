...
val exampleCases: List[(java.io.File, String, Boolean, List[String])] = List(
  ...
  (sampleResource("petstore.json"), "examples/v2.0", false, List("--import", "support.PositiveLong")),
  (sampleResource("petstore-3.0.yaml"), "examples/v3.0", false, List("--import", "support.PositiveLong")),
